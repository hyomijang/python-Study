...
# 문자열 -> 숫자형 (int,float) 숫자/부울형 => 문자열(str)
# 당신의 나잇값을 받아서 출력하는 프로그램 작성
...
# print("파이썬","자바") #파이썬 자바
# print("파이썬","자바","자바스크립트","스프링부트",sep=" , ") #파이썬 자바
# print("파이썬","자바",sep="/",end=" ? ") #파이썬자바
# print("파이썬","자바") 

#표준화면출력 (기본 print),표준에러출력
# import sys
# print("파이썬","자바",sep="," ,file=sys.stdout) 
# print("파이썬","자바",sep="," ,file=sys.stderr)

#출력화면 서식지정1 (자바: %10s %10s) ljust(size):왼쪽정렬 rjust(size):오른쪽정렬
# scores = {"수학" : 100 , "영어" : 90, "국어" : 70} #<class 'dict'>
...
#출력화면 서식지정 2 zfill(사이즈) : 전체사이즈를 설계하고 나머지 공간을 0 으로 채운다.

#for i in range(1,21):
#  print("num = "+ str(i).zfill(3)) #num : 001 num : 002

#출력화면 서식지정 3 format() 형식
print("{}".format(100))
print("{0}".format(100))
...
print("{0:_>+30,}".format(1000000000))  #________________+1,000,000,000

print("{0:f}".format(95.63463))  #95.634630
print("{0:10.2f}".format(95.75756))  # 95.76
